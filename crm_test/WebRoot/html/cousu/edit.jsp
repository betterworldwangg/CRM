...
<form action="cousu_realEdit" method="post">
<table width="89%" class="emp_table"    style="margin-top:5px; margin-left:55px;" align="left" cellspacing="0">
  ...
  <tr>
    ...
    <td width="18%" align="left"><s:textfield name="name" theme="simple"/></td>
    <td width="8%" align="left">联系地址：</td>
    <td width="19%" align="left"><s:textfield name="addres" theme="simple"/></td>
    <td width="7%" align="left">意向班级：</td>
    <td width="41%" align="left"><s:select list="clazzlist" name="clazz.id" listKey="id" listValue="name" theme="simple"></s:select></td>
  </tr>
  <tr>
    <td height="25" align="left">学校：</td>
    <td align="left"><s:textfield name="school" theme="simple"/></td>
    <td align="left">QQ：</td>
    <td align="left"><s:textfield name="qq" theme="simple"/></td>
    <td align="left">电话：</td>
  ...
  <tr>
    ...
    <td align="left">学历：</td>
    <td align="left"><s:textfield theme="simple" name="education"/></td>
  </tr>
  <tr>
    <td height="27">备注：</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td height="77">&nbsp;</td>
    <td colspan="5"><s:textarea theme="simple" name="description" cols="60" rows="5"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
