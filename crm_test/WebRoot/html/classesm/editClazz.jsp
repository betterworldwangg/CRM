...
<form action="clazz_realEdit" method="post">
<table width="88%" border="0" class="emp_table" style="width:80%;">
  <tr>
    <td width="10%">班级名称：</td>
    <td width="20%"><s:textfield name="name" type="text" theme="simple"/></td>
    <td width="8%">所属类别：</td>
  ...
  <tr>
   <td>开课时间：</td>
	    <td><input onfocus="c.showMoreDay=false;c.show(this);" name="beginTime" value='<s:date name="beginTime" format="yyyy-MM-dd"/>' type="text" /></td>
	    <td>结业时间：</td>
	    <td><input onfocus="c.showMoreDay=false;c.show(this);" name="endTime" value='<s:date name="endTime" format="yyyy-MM-dd"/>' type="text" /></td>
  </tr>
  <tr>
    <td>状态：</td>
